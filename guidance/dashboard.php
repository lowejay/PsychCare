                                    ...
                                    <div class="table-responsive table--no-card m-b-40">
                                        <table class="table table-borderless table-striped table-earning">
                                            ...
                                            <?php if (isset($noresult)){ ?>
                                                ...
                                                <tr>
                                                    <td hidden><?php $id = $r['appointment_ID']; ?></td>
                                                    <td><?php echo date('M d, Y ',strtotime($r['date_available'])); ?></td>
                                                    <td><?php echo date('h:i A ',strtotime($r['time_start'])); ?></td>
                                                    <td><?php echo date('h:i A ',strtotime($r['time_end'])); ?></td>
                                ...
                                <form method="POST" action="../controllers/guidance_controller.php">
                                    ...
                                    <div class="row p-t-25">
                                        ...
                                        <div class="col-2">
                                            <div class="form-group m-b-0">
                                                <label>Until </label>
                                                <input type="time" class="form-control time-until" name="time-until" min="08:00" max="18:00" step="1800" onblur="validateAppointmentTime();" required>
                                            </div>
                                        </div>
                                    </div>
