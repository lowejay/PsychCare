				...
				<div class="row">
					...
					<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
						<div class="about-desc">
							...
							<p>According to Tech News, the different learning styles varies, a typical classroom will contain 20% Visual Learners, 25% auditory learners, 15% kinesthetic learner and the remaining 30% consisting of students with mixed learning styles. This is an interesting statistic that supports that learning methods should cater to all types of learners.</p>
						</div>
								...
								<div class="panel panel-default">
								    <div class="panel-heading" role="tab" id="headingOne">
								        <h4 class="panel-title">
								            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">The 3 Learning Styles
								            </a>
								        </h4>
								    </div>
								         ...
								         <div class="panel-body">
								            <div class="row">
									    		<ul>
													<li>
														<span class="icon">
															<i class="icon-book2"> - <strong> The Linguistic Learner</strong>
															</i>
														</span>
													</li>
													<li>
														<span class="icon">
															<i class="icon-heart3"> - <strong> The Kinesthetic Learner</strong>
															</i>
														</span>
													</li>
													<li>
														<span class="icon">
															<i class="icon-eye2"> - <strong> The Visual / Spatial Learner</strong>
															</i>
														</span>
													</li>
												</ul>
