	...
	<div id="colorlib-main">
		<div class="colorlib-about">
			<div class="container-fluid">
				<?php if ($score >= 0 && $score <=8 ){?>
				<div class="row">
					<div class="col-md-6">
						<div class="about-img animate-box" data-animate-effect="fadeInLeft" style="background-image: url(../images/disorder/dep1.jpg);">
							<div class="about-img-2 animate-box" data-animate-effect="fadeInRight" style="background-image: url(../images/disorder/dep2.jpg);">
							</div>
						</div>
					</div>
					<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="fancy-collapse-panel">
							<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
								...
								<br>
								<p>
									<a href="test_disorder.php" class="btn btn-primary">Take Another Screen</a>
								</p>
							</div>
						</div>
					</div>
				</div>
				<?php }else if($score >= 9 && $score <=16 ){?>
				<div class="row">
					<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
						<div class="about-desc">
							<span class="heading-meta">This is really bad...</span>
							<h3>You scored a total of <?php echo $score; ?> point(s)</h3>
							<p>This is the results from your exam.</p>
						</div>
						<div class="fancy-collapse-panel">
								         ...
								         <div class="panel-body">
								            <div class="row">
									      		<div>
									      			...
									      			<br>
									      			<a href="../../student/myappointments.php" class="btn btn-primary">Please Consult</a>
									      			</p>
									      		</div>
									      	</div>
								         </div>
