                                ...
                                <div class="header-button">
                                    ...
                                    <div class="account-wrap">
                                        <div class="account-item clearfix js-item-menu">
                                            <div class="image">
                                                <img src="../images/icon/avatar-02.jpg" alt="Admin-one" />
                                            </div>
                                            <div class="content">
                                ...
                                <div class="card">
                                    <center>
                                        <div class="card-body">
                                            ...
                                            <h3 class="text-center p-t-15"><?php echo $_SESSION['student_FN']." ".$_SESSION['student_LN'];?></h3>
                                            <h5 class="text-center p-t-10"><?php echo $_SESSION['student_Email']; ?></h5>
                                            <hr>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="../controllers/student_controller.php" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                <label for="fname" class="control-label mb-1">First Name</label>
                                                <input type="hidden" value="<?php echo $_SESSION['student_ID'] ?>" name="student_ID"> 
                                                <input id="fname" name="fname" type="text" class="form-control" value="<?php echo $_SESSION['student_FN'];?>" aria-required>
                                            </div>
                                            <div class="form-group">
                                                <label for="lname" class="control-label mb-1">Last Name</label>
                                                <input id="lname" name="lname" type="text" class="form-control" value="<?php echo $_SESSION['student_LN'];?>"  aria-required>
                                            </div>
                                            <div class="form-group">
                                                <label for="lname" class="control-label mb-1">Email</label>
                                                <input id="lname" name="email" type="text" class="form-control" value="<?php echo $_SESSION['student_Email'];?>" aria-required>
                                            </div>
                                            <div class="form-group choose-file">
                                                <input type="file" class="form-control-file d-inline" name="img" value="#" required>
                                            </div>
                                            <div>
                                                    <button type="submit" class="btn btn-lg btn-info au-btn--block" value="saveProfilePost" name="saveProfilePost" >Save Changes</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                ...
                <div class="modal-dialog modal-lg modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="../controllers/student_controller.php" method="post" novalidate="novalidate"><?php require('../views/alert.php') ?>
                                <div class="form-group">
                                    <input type="hidden" name="student_ID" value="<?php echo $_SESSION['student_ID']; ?>">
                                    <label for="fname" class="control-label mb-1">Current Password</label>
                                    <input id="fname" name="cur_pass" type="text" class="form-control" aria-required>
                                </div>
                                <div class="form-group">
                                    <label for="lname" class="control-label mb-1">New Password</label>
                                    <input id="lname" name="new_pass" type="text" class="form-control" aria-required>
                                </div>
                                <div class="form-group">
                                    <label for="lname" class="control-label mb-1">Confirm New Password</label>
                                    <input id="lname" name="con_pass" type="text" class="form-control" aria-required>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" name="changePassPost" value="changePassPost" class="btn au-btn--blue">Confirm</button>
