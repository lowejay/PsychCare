...
function addNewSched(){
	...
	if ($time >= $time2){
		...
		$sql = "INSERT INTO data_appointment(appointment_ID, emp_ID, date_available, time_start, time_end, contact_no, appointment_status) VALUES ('$schedid','$userid','$date','$time','$time2','$cont','$status')";
