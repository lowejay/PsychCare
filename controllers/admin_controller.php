...
function deleteStudent($id){
	...
	if($result){
		$str = "Student $id has been removed";
		header("Location:../admin/student.php?msgstu=$str");
	}else{
...
function removeEmployee($id){
	...
	$result = mysqli_query($conn, $query);
	if($result){
		$str = "Employee $id has been removed";
		header("Location:../admin/employee.php?msgem=$str");
	}else{
