                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="../controllers/admin_controller.php" method="post" novalidate="novalidate">
                ...
                <div class="modal-dialog modal-lg modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="../controllers/admin_controller.php" method="post" novalidate="novalidate"><?php require('../views/alert.php') ?>
                                <div class="form-group">
