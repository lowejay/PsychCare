                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#modalAddSched">
                                            <i class="zmdi zmdi-plus"></i>Add Schedule
                                        </button>     
                                    </div>
                                </div>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <button class="item edit_this" data-toggle="tooltip" data-placement="top" title="Edit" type="button" id="<?php echo $row['class_ID'];?>">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="select-course" class="control-label mb-1">Course</label>
                                                <select name="select-course" id="select-course" class="form-control selection" required>
                                                    <option value=""></option>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="course-title" class="control-label mb-1">Subject</label>
                                            <input id="course-title" name="course-title" type="text" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule" required>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <select name="select-sched" id="select-sched" class="form-control selection" required>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="time-from" class="control-label mb-1">Time-Start</label>
                                            <input id="time-from" name="time-from" type="time" class="form-control" data-val="true" data-val-required="Please enter the Time Start" required>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="time-until" class="control-label mb-1">Time-End</label>
                                            <input id="time-until" name="time-until" type="time" class="form-control" data-val="true" data-val-required="Please enter the Time-End" required>
