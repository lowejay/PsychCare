...
$result =  loadVacantAppointments($emp_ID);if (mysqli_num_rows($result)==0) {$noresult = 0;}
$result2 = loadOccupiedAppointments($emp_ID);if (mysqli_num_rows($result2)==0) {$noresult2 = 0;}
$result3 = loadCompletedAppointments($emp_ID);if (mysqli_num_rows($result3)==0) {$noresult3 = 0;}?>
