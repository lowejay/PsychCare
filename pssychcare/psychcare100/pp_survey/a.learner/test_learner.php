				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3">
							<h4 class="animate-box">Types of Learner</h4>
	                    	...
	                    	<tbody>
	                    		<?php foreach($result as $row)
                    				...
                    				<tr style="font-size: 15px">
                    					...
                    					<td scope="col-md-10 "><?php echo $row['learner_question'] ?></td>
                    					<td scope="col-md-10 "><?php echo $row['learner_choices'] ?></td>
