									         ...
									         <div class="panel-body">
									            <div class="row">
										    		<ul>
														...
														<li><span class="icon"><i class="icon-leaf">-<strong>The Naturalist</strong></i></span></li>
														<li><span class="icon"><i class="icon-headphones">-<strong>The Musical / Rythmic Learner</strong></i></span></li>
														...
														<li><span class="icon"><i class="icon-plus2">-<strong>The Logical / Mathematical Learner</strong></i></span></li>
														<li><span class="icon"><i class="icon-group-outline">-<strong>The Interpersonal Learner</strong></i></span></li>
														<li><span class="icon"><i class="icon-user2">-<strong>The Intrapersonal Learner</strong></i></span></li>
													</ul>
										      	</div>
									         </div>
									    </div>
									    ...
									    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
									        <div class="panel-body">									       
								            	<ul>
													...
													<li><strong>The Naturalist</strong> - learns by working with, and experiencing, nature.</li>
													<li><strong>The Musical / Rythmic Learner</strong> - is one who learns using melody or rhythm.</li>
													...
													<li><strong>The Logical / Mathematical Learner</strong> - learner must categorize or classify things.</li>
													<li><strong>The Interpersonal Learner</strong> - is someone who learns by relating to others.</li>
													<li><strong>The Intrapersonal Learner</strong> - is someone who works and learns best when they are alone.</li>
												</ul>	
									        </div>
									    </div>
									</div>
