                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row m-t-25 m-b-40">
                            <div class="col-3">
                                <button class="overview-item overview-item--c1 " type="button" data-id="IDr" data-toggle="modal" data-target="#modalAddData">
                                    <div class="col">
                            ...
                            <div class="col-3">
                                <button class="overview-item overview-item--c2 m-b-40" type="button" data-id="TL" data-toggle="modal" data-target="#modalAddData">
                                    <div class="col">
                                        <div class="overview__inner">
                            ...
                            <div class="col-3">
                                <button class="overview-item overview-item--c3" type="button" data-id="PT" data-toggle="modal" data-target="#modalAddData">
                                    <div class="col">
                                        <div class="overview__inner">
                                            <div class="overview-box">
                                                <div class="icon">
                            ...
                            <div class="col-3">
                                <button class="overview-item overview-item--c4" type="button" data-id="PD" data-toggle="modal" data-target="#modalAddData">
                                    <div class="col">
                                        <div class="overview__inner">
                                            <div class="overview-box clearfix">
                                                <div class="icon">
