                                ...
                                <table class="table table-borderless table-striped table-earning">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="../controllers/admin_controller.php?emp_ID=<?php echo $row['emp_ID']?>" onclick="confirm('Are you sure you want to delete this employee?')"><button class="item" data-toggle="tooltip" data-placement="top" title="Delete"><i class="zmdi zmdi-delete"></i></button></a></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>   
                                </table>
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <input id="emp_ID" name="emp_ID" type="text" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule"/>
                                        <span class="help-block" data-valmsg-for="emp_ID" data-valmsg-summary="true"></span>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
                                        <label for="emp_LN" class="control-label mb-1">Last Name</label>
                                        <input id="emp_LN" name="emp_LN" type="text" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule"/>
                                        <span class="help-block" data-valmsg-for="emp_LN" data-valmsg-summary="true"></span>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
                                        <label for="emp_FN" class="control-label mb-1">First Name</label>
                                        <input id="emp_FN" name="emp_FN" type="text" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule"/>
                                        <span class="help-block" data-valmsg-for="emp_FN" data-valmsg-summary="true"></span>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
                                        <label for="emp_Email" class="control-label mb-1">Email</label>
                                        <input id="emp_Email" name="emp_Email" type="text" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule"/>
                                        <span class="help-block" data-valmsg-for="emp_Email" data-valmsg-summary="true"></span>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
                                        <label for="emp_Contact" class="control-label mb-1">Contact</label>
                                        <input id="emp_Contact" name="emp_Contact" type="text" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule"/>
                                        <span class="help-block" data-valmsg-for="emp_Contact" data-valmsg-summary="true"></span>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
                                        <label for="emp_Privilege" class="control-label mb-1">Privilege</label>
                                        <input id="emp_Privilege" name="emp_Privilege" type="text" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule"/>
                                        <span class="help-block" data-valmsg-for="emp_Privilege" data-valmsg-summary="true"></span>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
                                        <label for="emp_Password" class="control-label mb-1">Password</label>
                                        <input id="emp_Password" name="emp_Password" type="password" class="form-control" data-val="true" data-val-required="Please enter the Class Schedule"/>
                                        <span class="help-block" data-valmsg-for="emp_Password" data-valmsg-summary="true"></span>
                                    </div>
                                </div>
