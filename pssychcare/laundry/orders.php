	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 offset-md-2 text-center">
				<!-- Title text -->
				<h3><i class="fa fa-shopping-bag" aria-hidden="true"></i> Orders</h3>
			</div>
		</div>
	</div>
	<!-- Container End -->
			...
			<div class="col-md-10 offset-md-1 col-lg-12 offset-lg-0">
				<div class="sidebar">
					...
					<div class="widget category">
						<!-- Widget Header -->
						<h5 class="widget-header"><i class="fa fa-exclamation-triangle"></i> Pending Laundry Orders</h5>
		                    	...
		                    	<tbody>
			                    	<?php while ($row=mysqli_fetch_array($result)) {?>
				                    	<tr style='font-size:14px'>
			                        		...
			                        		<td><a href="order_details.php?id=<?php echo $row['id']?>" class="btn btn-info btn-sm">
			                        		<i class="fa fa-eye"></i></a></td>
			                        		<form action="claim.php" method="post">
			                        			<td><button type="submit" name="id" value="<?php echo $row['id'] ?>" class="btn btn-success btn-sm">Claim <i class="fa fa-check"></i></button></td>
			                        		</form>
			                        	</tr>
			                    	<?php } ?>
			                    </tbody>
