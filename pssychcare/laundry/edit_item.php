	...
	<div class="container">
		<div class="row">
			<div class="col-md-8 offset-md-2 text-center">
				<!-- Title text -->
				<h3><i class="fa fa-black-tie" aria-hidden="true"></i> Edit Items</h3>
			</div>
		</div>
	</div>
	<!-- Container End -->
	...
	<div class="container">
		<div class="row">
			<div class="col-md-10 offset-md-1 col-lg-5 offset-lg-0">
				<div class="sidebar">
					<a type="submit" href="items.php" value="Back" class="btn btn-info col-md-2" style="margin-bottom:5%"><i class="fa fa-arrow-left"></i></a>
					<div class="widget category">
						<!-- Widget Header -->
						<h5 class="widget-header"><i class="fa fa-edit"></i> Edit Item</h5>
							...
							<?php while ($row=mysqli_fetch_array($result2)) {?>
								...
								<div class="col-sm-12 col-md-12">
									<div class="form-group mb-30">
										...
										<input type="text" class="form-control" name="price_kilo" value="<?php echo $row['price_kilo']?>" required>
									</div>
								</div>
								<div class="col-sm-12 col-md-12">
									<div class="form-group mb-30">
										<input type="submit" value="Edit" class="btn btn-success col-md-12">
									</div>
								</div>
							<?php }?>
                        </form>
