				...
				<div class="widget personal-info">
					...
					<form method="post" action="edit_profile.php" enctype="multipart/form-data">
						<div class="form-group">
						    ...
						    <input type="text" class="form-control" name="fname" value="<?php echo $userRow['1'] ?>" required>
						</div>
						<div class="form-group">
						    <label for="last-name">Last Name</label>
						    <input type="text" class="form-control" name="lname" value="<?php echo $userRow['2'] ?>" required>
						</div>
						<div class="form-group">
						    <label for="last-name">Username</label>
						    <input type="text" class="form-control" name="username" value="<?php echo $userRow['3'] ?>" required>
						</div>
						<div class="form-group choose-file">
							<i class="fa fa-user text-center"></i>
						    <input type="file" class="form-control-file d-inline" name="img" value="<?php $userRow['4'] ?>" required>
						 </div>
						<input type="submit" name="submit" class="btn btn-transparent col-md-12" value="Save My Changes">
					</form>
				</div>
			</div>
		</div>
