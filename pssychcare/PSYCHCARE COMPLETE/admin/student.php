                    ...
                    <div class="table-responsive m-b-40 p-l-100 p-r-70">
                        <table class="table table-borderless table-data3">
                            ...
                            <?php foreach($result as $row){?>
                                <tr>
                                    <td hidden><?php $id = $row['student_ID'] ?></td>
                            ...
                            <div class="row">
                                <div class="col-5">
                                    <div class="form-group">
                                        <label for="student_ID" class="control-label">ID Number</label>
                                ...
                                <div class="col-5">
                                    <div class="form-group">
                                        ...
                                        <input id="student_Contact" name="student_Contact" type="text" class="form-control" required/>
                                    </div>
                                </div>
                                <div class="col-5">
                                    <div class="form-group">
