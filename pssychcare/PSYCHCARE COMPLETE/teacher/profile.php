                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="../controllers/teacher_controller.php" method="post" novalidate="novalidate">
                ...
                <div class="modal-dialog modal-lg modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="../controllers/teacher_controller.php" method="post" novalidate="novalidate"><?php require('../views/alert.php') ?>
                                <div class="form-group">
                                    <input type="hidden" name="emp_ID" value="<?php echo $_SESSION['emp_ID']; ?>">
                                    <label  class="control-label mb-1">Current Password</label>
                                    <input  name="cur_pass" type="text" class="form-control" aria-required>
                                </div>
                                <div class="form-group">
                                    <label  class="control-label mb-1">New Password</label>
                                    <input name="new_pass" type="text" class="form-control" aria-required>
                                </div>
                                <div class="form-group">
                                    <label for="lname" class="control-label mb-1">Confirm New Password</label>
                                    <input name="con_pass" type="text" class="form-control" aria-required>
                                </div>
