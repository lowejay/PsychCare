...
function removeAppointment($id){
	...
	$query = "UPDATE data_appointment SET appointment_status='cancelled' WHERE schedule_ID = '$id'";
...
function setDoneAppointment($id){
	$conn = myConnect();
	$sql = "UPDATE data_appointment SET appointment_status='done' WHERE schedule_ID='$id'";
	$result = mysqli_query($conn,$sql);
