                                ...
                                <div class="card">
                                    <center>
                                        <div class="card-body">
                                            ...
                                            <h3 class="text-center p-t-15"><?php echo $_SESSION['emp_FN']." ".$_SESSION['emp_LN'];?></h3>
                                            <h5 class="text-center p-t-10"><?php echo $_SESSION['emp_Email']; ?></h5>
                                            <hr>
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <hr>
                                        <form action="../controllers/guidance_controller.php" method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="lname" name="email" type="text" class="form-control" value="<?php echo $_SESSION['emp_Email'];?>" aria-required>
                                            </div>
                ...
                <div class="modal-dialog modal-lg modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="../controllers/guidance_controller.php" method="post" novalidate="novalidate"><?php require('../views/alert.php') ?>
                                <div class="form-group">
