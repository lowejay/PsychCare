                ...
                <div class="row">
                    <div class="col-5 types" id="PD">
                        <div class="form-group">
                            <label for="psy-dis" class="control-label mb-1">Phychological Disorder</label>
      ...
      <div class="modal-body">
        <form method="post" action="../controllers/survey_controller.php">
            <div class="form-group">
                    ...
                    <textarea class="form-control" name="name" aria-describedby="emailHelp" placeholder="Name"></textarea>
            </div>
            <div class="form-group">
                    <label for="exampleInputEmail1">Meaning</label>
                    <textarea class="form-control" name="meaning" aria-describedby="emailHelp" placeholder="Meaning"></textarea>
            </div>
...
<div class="modal fade" id="disorderModal" tabindex="-1" role="dialog" aria-labelledby="disorderModalLable" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="disorderModal">Psychoogical Disorder</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
