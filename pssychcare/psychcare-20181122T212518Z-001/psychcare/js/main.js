...
function removethisStudent(id){
    ...
    .then((remove) => {
      if (remove) {
        window.location='../controllers/admin_controller.php?this-student='+id;
      }else{
...
function loadStudents(id){
  ...
  $(document).ready(function () {
      $("#modalAddStud").modal("toggle");
      $("#addModaltable").load("../controllers/teacher_controller.php?student-of=$id");
 });
}
