		                    	...
		                    	<tbody>
		                    		<?php while ($row = mysqli_fetch_array($result)) {?>
	                    				<tr style="font-size: 15px">
	                    					...
	                    					<td scope="col" align="center"><input type="radio" name="answer_<?php echo $row['personality_id']?>" id="et_<?php echo $row['personality_id']?>" value="4"></td>
	                                		<td scope="col" align="center"><input type="radio" name="answer_<?php echo $row['personality_id']?>" id="ot_<?php echo $row['personality_id']?>" value="3"></td>
	                                		<td scope="col" align="center"><input type="radio" name="answer_<?php echo $row['personality_id']?>" id="ot_<?php echo $row['personality_id']?>" value="2"></td>
